...
export const BADGE_TIERS: { [key in BadgeTier]: { minPercent: number, color: string, icon: string } } = {
  ...
  [BadgeTier.SHARK]: { minPercent: 0.03, color: 'text-blue-600 bg-blue-100 border-blue-200 dark:bg-blue-900/20 dark:border-blue-800', icon: '🦈' },
  [BadgeTier.LION]: { minPercent: 0.06, color: 'text-yellow-600 bg-yellow-100 border-yellow-200 dark:bg-yellow-900/20 dark:border-yellow-800', icon: '🦁' },
  [BadgeTier.KING_COBRA]: { minPercent: 0.1, color: 'text-green-600 bg-green-100 border-green-200 dark:bg-green-900/20 dark:border-green-800', icon: '🐍' },
  [BadgeTier.KILLER_WHALE]: { minPercent: 0.3, color: 'text-indigo-500 bg-indigo-100 border-indigo-200 dark:bg-indigo-900/20 dark:border-indigo-800', icon: '🐋' },
  [BadgeTier.GREAT_APE]: { minPercent: 0.6, color: 'text-amber-700 bg-amber-100 border-amber-200 dark:bg-amber-900/20 dark:border-amber-700', icon: '🦍' },

      ...
      <div className="icc-container">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 text-center md:text-left">
          <div className="md:col-span-1 flex flex-col items-center md:items-start">
            ...
            <p className="text-sm text-gray-300 dark:text-gray-400 mt-4 max-w-xs text-center my-0 md:text-left">
          ...
          <div className="text-center md:text-left">
            ...
            <ul className="space-y-2">
              <li>
                <button onClick={() => setAboutOpen(true)} className="text-gray-300 dark:text-gray-400 hover:text-icc-gold dark:hover:text-icc-gold text-sm text-center md:text-left w-full py-1 px-0 rounded transition-colors">
                  About SEC
                </button>
              </li>
              <li>
                <button onClick={() => setFaqOpen(true)} className="text-gray-300 dark:text-gray-400 hover:text-icc-gold dark:hover:text-icc-gold text-sm text-center md:text-left w-full py-1 px-0 rounded transition-colors">
                  FAQ
                </button>
              </li>
              <li>
                <button onClick={() => setContactOpen(true)} className="text-gray-300 dark:text-gray-400 hover:text-icc-gold dark:hover:text-icc-gold text-sm text-center md:text-left w-full py-1 px-0 rounded transition-colors">
                  Contact Us
                </button>
              </li>
              <li>
                <button onClick={() => setSafetyOpen(true)} className="text-gray-300 dark:text-gray-400 hover:text-icc-gold dark:hover:text-icc-gold text-sm text-center md:text-left w-full py-1 px-0 rounded transition-colors">
                  Safety Guidelines
                </button>
              </li>
              <li>
                <Link to="/community" className="text-gray-300 dark:text-gray-400 hover:text-icc-gold dark:hover:text-icc-gold text-sm text-center md:text-left w-full py-1 px-0 rounded transition-colors">
                  Community
                </Link>
              </li>
              <li>
                <a href="https://solscan.io/token/HocVFWDa8JFg4NG33TetK4sYJwcACKob6uMeMFKhpump" target="_blank" rel="noopener noreferrer" className="text-gray-300 dark:text-gray-400 hover:text-icc-gold dark:hover:text-icc-gold text-sm text-center md:text-left w-full py-1 px-0 rounded transition-colors">
                  SEC Token
                </a>
              </li>
            </ul>
          ...
          <div className="text-center md:text-left">
            ...
            <ul className="space-y-2">
              <li>
                <button onClick={() => setTermsOpen(true)} className="text-gray-300 dark:text-gray-400 hover:text-icc-gold dark:hover:text-icc-gold text-sm text-center md:text-left w-full py-1 px-0 rounded transition-colors">
                  Terms of Service
                </button>
              </li>
              <li>
                <button onClick={() => setPrivacyOpen(true)} className="text-gray-300 dark:text-gray-400 hover:text-icc-gold dark:hover:text-icc-gold text-sm text-center md:text-left w-full py-1 px-0 rounded transition-colors">
                  Privacy Policy
                </button>
              </li>
              <li>
                <button onClick={() => setDisclaimerOpen(true)} className="text-gray-300 dark:text-gray-400 hover:text-icc-gold dark:hover:text-icc-gold text-sm text-center md:text-left w-full py-1 px-0 rounded transition-colors">
                  Disclaimer
                </button>
              </li>
              <li>
                <button onClick={() => setCookiesOpen(true)} className="text-gray-300 dark:text-gray-400 hover:text-icc-gold dark:hover:text-icc-gold text-sm text-center md:text-left w-full py-1 px-0 rounded transition-colors">
                  Cookie Policy
                </button>
              </li>
            </ul>
        ...
        <div className="border-t border-icc-blue-light dark:border-gray-700 mt-8 pt-8 text-sm text-gray-300 dark:text-gray-500 text-center">

      ...
      <div className="icc-container">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 text-center md:text-left">
          <div className="md:col-span-1 flex flex-col items-center md:items-start">
            ...
            <p className="text-sm text-gray-300 dark:text-gray-400 mt-4 max-w-xs text-center md:text-left">
            ...
            <ul className="space-y-2">
              ...
              <li>
                <a 
                  ...
                  className="text-gray-300 dark:text-gray-400 hover:text-icc-gold dark:hover:text-icc-gold text-sm text-center md:text-left w-full py-1 px-0 rounded transition-colors"
                >
                  SEC Token
                </a>
              </li>

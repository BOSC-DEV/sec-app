  ...
  return <Card className="w-full">
      ...
      <CardContent>
        {walletAddress ? <div className="space-y-4">
            <div>
              <div className="text-sm font-medium mb-1 text-gray-500 px-0 my-[20px]">Wallet Address</div>
            ...
            {isOwnProfile && <div className="pt-4">
                <Button variant="outline" className="w-full border-icc-red text-icc-red hover:bg-icc-red-light/10 hover:text-icc-red flex items-center justify-center gap-2" onClick={handleDisconnect}>

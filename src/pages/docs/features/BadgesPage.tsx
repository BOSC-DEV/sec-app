...
const BadgesPage = () => {
  return (
    <DocsContent 
      ...
      description="Learn about the community recognition system and how to advance through different tiers"
    >
            ...
            <div className="p-6 border-2 border-blue-400 rounded-lg bg-blue-50 dark:bg-blue-950">
              ...
              <div className="grid md:grid-cols-2 gap-4">
                ...
                <div>
                  <h4 className="font-semibold mb-2">Benefits:</h4>
                  <ul className="space-y-1 text-sm">
                    <li>• Maximum voting power</li>
                    <li>• Governance participation</li>
                    <li>• Direct dev team access</li>

      ...
      <section className="bg-icc-red text-white py-10">
        <div className="icc-container">
          <div className="flex flex-col md:flex-row items-center justify-between">
            ...
            <Button variant="outline" onClick={() => setDisclaimerOpen(true)} className="border-white text-white hover:text-white bg-slate-900 hover:bg-slate-800">
              Read Disclaimer
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
            {isLoadingStats ? <>
                ...
                <div className="text-center p-6">
                  ...
                  <div className="text-sm text-icc-gray">Total Bounties</div>
                </div>
                <div className="text-center p-6">
                  <div className="text-4xl font-bold text-icc-blue mb-2">{formatNumber(statistics.scammersCount)}</div>
                  <div className="text-sm text-icc-gray">Total Reports</div>
                </div>
                <div className="text-center p-6">

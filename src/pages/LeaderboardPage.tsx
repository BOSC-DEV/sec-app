          ...
          {isLoading ? <div className="p-6 space-y-4">
              ...
              <TooltipProvider>
                <Table>
                  ...
                  <TableBody>
                    {sortedProfiles.length === 0 ? <TableRow>
                        <TableCell colSpan={9} className="text-center py-12">
                      ...
                      </TableRow> : sortedProfiles.map((profile, index) => <TableRow key={profile.id} className="border-b border-icc-gold/30 hover:bg-icc-gold/10 transition-colors">
                          ...
                          <TableCell className="text-center">
                            <div className="flex items-center justify-center gap-1">
                              {profile.x_link && <a href={profile.x_link} target="_blank" rel="noopener noreferrer" className="inline-block p-2 rounded-full bg-icc-blue hover:bg-icc-blue-light transition-colors" aria-label={`${profile.display_name} on X`}>
                                  <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="text-white">
                                    <path d="M22 4s-.7 2.1-2 3.4c1.6 10-9.4 17.3-18 11.6 2.2.1 4.4-.6 6-2C3 15.5.5 9.6 3 5c2.2 2.6 5.6 4.1 9 4-.9-4.2 4-6.6 7-3.8 1.1 0 3-1.2 3-1.2z" />
                                  </svg>
                                </a>}
                              {profile.website_link && <a href={profile.website_link} target="_blank" rel="noopener noreferrer" className="inline-block p-2 rounded-full bg-icc-blue hover:bg-icc-blue-light transition-colors" aria-label={`${profile.display_name}'s website`}>
                          ...
                          <TableCell className="text-center font-semibold text-icc-primary">
                            <Link to={`/profile/${profile.username || profile.wallet_address}`} className="hover:underline">
                              {profile.bounty_amount ? <span className="flex items-center justify-center">
